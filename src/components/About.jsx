  ...
  return (
    <div className="px-8 w-full md:w-7xl  m-auto pt-12 mt-1 pb-2">
      <div className="text-center mt-4 flex flex-col gap-2">
        ...
        className="tracking-tight">Lorem ipsum dolor sit amet.</motion.p>
      </div>
      ...
      <div className="flex md:flex-row flex-col justify-around mt-8 ">
        ...
        <div className="w-full md:w-[34vw] flex flex-col gap-3 md:mt-0 mt-4">
          <h2>My Journey</h2>
          <p 
          className="text-gray-400 text-[0.9rem]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui nobis
            nihil amet, voluptate quae fugit sequi maxime officia nulla ex rem
            deleniti libero sed omnis repellat, delectus esse doloremque magnam?
          </p>
